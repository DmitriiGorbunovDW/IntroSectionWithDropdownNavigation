...
<template>
    <nav class="nav" :class="{ 'is-open': isOpen }" @click="isOpen = false">
        ...
        <div class="nav-burger" @click.stop="isOpen = !isOpen" role="button">
      <img
      ...
      />
        ...
        <div class="nav-body">
            <div class="nav-start">
                ...
                <dropdown class="nav-link" text="Company" :items="company" align="right" />
                <router-link class="nav-link" :to="{ name: 'careers' }">Careers</router-link>
                <router-link class="nav-link" :to="{ name: 'about' }">About</router-link>
            </div>

            <div class="nav-end">
                <router-link class="nav-link" :to="{ name: 'login' }">Login</router-link>
                <router-link class="nav-link button" :to="{ name: 'register' }">Register</router-link>
            </div>
        </div>
    </nav>
</template>
